...
\classdesc{OpenFileCommand}{Opens a file.} {   \begin{itemize}
        \item \atrdesc{\private}{}{\type{Library}}{openedLibrary}{The opened library}
    \end{itemize}
}
{
    {\begin{itemize}
...
\classdesc{RemoveCommand}{Removes a library from the view.}
    {\begin{itemize}
...
\classdesc{AddFilterCommand}{Adds a filter.}
    {\begin{itemize}
...
\classdesc{RemoveFilterCommand}{Removes a filter.}
    {\begin{itemize}
...
\classdesc{DeleteCommand}{Deletes a cell from a library.} % Make this for multiple cells perhaps? Quite easy to do
    {\begin{itemize}
...
\classdesc{MergeCommand}{Merges multiple selected libraries to a single library.}
    {\begin{itemize}
...
\classdesc{PasteCommand}{Moves copied cells to a desired library.}
    {\begin{itemize}
...
\classdesc{MoveCommand}{Moves selected cells to a desired library.}
    {\begin{itemize}
...
\classdesc{RenameCommand}{Changes the name of an element.}
    {\begin{itemize}
...
%    \end{itemize}
%%    }
\classdesc{CreateLibraryCommand}{Creates a library.} %What does this even do? I forgot
    {\begin{itemize}
...
\classdesc{ScaleCommand}{Scales the values of an attribute by a given float.}
    {\begin{itemize}
...
\classdesc{UndoCommand}{Undoes a Command.}{}
{\begin{itemize}
...
\classdesc{TextEditCommand}{Makes changes on the text editor reflect on an element.}
    {\begin{itemize}
...
\classdesc{CommandHistory}{Keeps the history of the executed Commands and manages it.}
    {\begin{itemize}
...
{   \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \methoddesc{\private}{}{void}{resetUndoneCommands}{Resets the undone commands. Usually because a whole new action has been done.}
        {}{}{}
...
\classdesc{NameConflictResolver}{Resolves naming conflicts while keeping track of the taken commandss}
    {\begin{itemize}
...
\classdesc{ConflictData}{Saves a data of the conflict resolution on two conflicting cells} 
    {\begin{itemize}
...
The enum that keeps track of the methods to resolve a name conflict
    ...
    \begin{itemize}
        ...
        \item \fielddesc{ResolutionMethod}{CANCEL}{Cancels the conflict resolution and therefore cancels the command}
    \end{itemize}
}{}
}
...
Keeps track off the settings
    ...
    \begin{itemize}
        ...
        \atrdesc{\private}{}{int}{undoCount}{The set number of undoable Commands saved in the CommandHistory}
...
\enumdesc{ColorEnum}{
The enum that keeps track of the colors corresponding to a \refer{\lblroot:model.project:ColorTheme}{theme}
}{
    \begin{itemize}
...
\enumdesc{Operation}{Keeps track of the type of operation done by the \refer{\lblroot:model.project:Filter}{Filter}}{
    \begin{itemize}
...
\enumdesc{ColorThemeEnum}{Keeps track of the \refer{\lblroot:model.project:ColorTheme:colors}{Color themes}}{
    \begin{itemize}
...
\enumdesc{LanguageEnum}{Keeps track of the \refer{\lblroot:model.project:Language}{languages} available for the program}{
    \begin{itemize}
