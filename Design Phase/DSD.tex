...
{
\begin{itemize}
        \item \methoddesc{\public}{}{void}{calculate}{}{Calculates the stats of the attributes.}
        {}{}
        \item \methoddesc{\private}{}{void}{scale}{\type{float} value}{Scales the values of the attribute.}
        {{\begin{itemize}
...
Removes a \refer{\lblroot:model.elements:Library}{library} from the \refer{\lblroot:model.project:Project}{project}.
}
}{
    \begin{itemize}
        \item \atrdesc{\private}{}{\type{Library}}{removedLibrary}{The library, that is removed from the project.}
    \end{itemize}} 
{   \begin{itemize}
        \item \constrdesc{\public}{RemoveCommand}{\type{Library} library}{}
        {
            \begin{itemize}
            \item \paramdesc{library}{The library that is going to be removed from the project.}
            \end{itemize}
        }
    \end{itemize}
}
...
Keeps track of the filters specific data and provides filtering functionality.
    ...
    \begin{itemize}
        ...
        \item \atrdesc{\private}{}{Status}{status}{If true, the filter is Active and will filter.\newline Else the filter is inactive and won't filter.}
    \end{itemize}
}{
    \begin{itemize}
...
Keeps track off the settings
    ...
    \begin{itemize}
        ...
        \item \atrdesc{\private}{}{boolean}{editorOpenedFirst}{If true, the Text Editor opens first upon opening an \refer{\lblroot:model.elements:Element}{Element} in the workspace.\newline
...
{enum Event \decl{}{Identifies each view listener for subscription.}
    ...
    \begin{itemize}
        ...
        \item \fielddesc{Event}{SELECT}{Listener for selecting elements in the outliner.}
        ...
        \item \fielddesc{Event}{EXPORTPROJECT}{Listener for exporting a project in CSV format.}
...
\classdesc{SelectListener}{\public \class LoadLibraryListener implements \type{TreeSelectionListener} \decl{}{Observes the selected elements on the outliner.}}{
    \begin{itemize}
        \item \atrdesc{\private}{}{ArrayList<EventListener>}{listeners}{List of listeners which are given the selected elements.}
        \item \atrdesc{\private}{}{ArrayList<Element>}{elements}{List of selected elements}
    \end{itemize}
}{
    \begin{itemize}
    ...
    \begin{itemize}
        \item \methoddesc{\public}{}{void}{valueChanged}{\type{TreeSelectionEvent} e}
        {}{\begin{itemize}
...
\classdesc{OpenElementListener}{\public \class OpenElementListener implements \type{ActionListener} \decl{}{Listener for opening an element in the working area of the application.}
    ...
    \begin{itemize}
        ...
        {}{\begin{itemize}
            ...
            \end{itemize}}{}
        \item \methoddesc{\public}{}{void}{setElement}{\type{Element} element}
        {Sets the selected element from the outliner.}{\begin{itemize}
            \item \paramdesc{element}{Selected element.}
            \end{itemize}}{}
    \end{itemize}
    }{}
\classdesc{DeleteCellListener}{\public \class DeleteCellListener implements \type{ActionListener} \decl{}{Listener for deleting a cell permanently from a library.}}{
    \begin{itemize}
        ...
        \item \atrdesc{\private}{}{ArrayList<Cell>}{deletedCells}{List of cells which will be deleted.}
    ...
    \begin{itemize}
        ...
        {Sets the selected cells from the outliner.}{\begin{itemize}
            \item \paramdesc{cells}{Selected cells.}
            \end{itemize}}{}
    \end{itemize}
}{}
\classdesc{RemoveListener}{\public \class RemoveListener implements \type{ActionListener} \decl{}{Listener for removing an element from the project.}}{
    \begin{itemize}
        ...
        \item \atrdesc{\private}{}{Library}{removedLibrary}{Library which will be removed.}
    \end{itemize}
}{
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        {}{\begin{itemize}
            \item \paramdesc{e}{Performed action event on the component.}
            \end{itemize}}{}
        \item \methoddesc{\public}{}{void}{setLibrary}{\type{Library} library}
        {Sets the selected library from the outliner.}{\begin{itemize}
            \item \paramdesc{library}{Selected library.}
            \end{itemize}}{}
    \end{itemize}
}{}
...
\classdesc{RenameListener}{\public \class RenameListener implements \type{ActionListener} \decl{}{Listener for renaming a liberty file in the outliner.}}{
    ...
    \end{itemize}}{}
\classdesc{SearchListener}{\public \class SearchListener implements TextListener \decl{}{Listener for the search bar.}}{
    \begin{itemize}
...
\classdesc{MergeListener}{\public \class MergeListener implements ActionListener \decl{}{Listener for merging multiple libraries.}}{
    \begin{itemize}
        ...
        \item \atrdesc{\private}{}{ArrayList<Library>}{libraries}{List of the libraries selected for merge action.}
    \end{itemize}
}{
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        {}{\begin{itemize}
            \item \paramdesc{e}{Performed action event on the component.}
            \end{itemize}}{}
         \item \methoddesc{\public}{}{void}{setLibraries}{\type{ArrayList<Library>} libraries}
        {Sets the selected libraries from the outliner.}{\begin{itemize}
            \item \paramdesc{libraries}{Selected libraries.}
            \end{itemize}}{}
    \end{itemize}}{}
...
\classdesc{CompareListener}{\public \class CompareListener implements ActionListener \decl{}{Listener for the compare action.}}{
    ...
    \begin{itemize}
        ...
        {}{\begin{itemize}
            \item \paramdesc{e}{Performed action event on the component.}
            \end{itemize}}{}
         \item \methoddesc{\public}{}{void}{setElements}{\type{ArrayList<Element>} elements}
        {Sets the selected elements from the outliner.}{\begin{itemize}
            \item \paramdesc{elements}{Selected elements.}
            \end{itemize}}{}
    \end{itemize}}{}
\classdesc{MoveListener}{\public \class MoveListener implements ActionListener \decl{}{Listener for moving selected cells to another library.}}{
    \begin{itemize}
        ...
        \item \atrdesc{\private}{}{ArrayList<Cell>}{cells}{List of the selected cells.}
    \end{itemize}
}{
    \begin{itemize}
...
\classdesc{CopyListener}{\public \class CopyListener implements ActionListener \decl{}{Listener for copying cells into another library.}}{
    \begin{itemize}
        ...
        \item \atrdesc{\private}{}{ArrayList<Cell>}{cells}{Cells selected for copying.}
    \end{itemize}
}{
    \begin{itemize}
...
\classdesc{PasteListener}{\public \class PasteListener implements ActionListener \decl{}{Listener for pasting selected cells for copying to another library.}}{
    \begin{itemize}
        ...
        \item \atrdesc{\private}{}{boolean}{copyTag}{To decide if copy or move action has been performed before.}
    ...
    \begin{itemize}
        ...
        {}{\begin{itemize}
            ...
            \end{itemize}}{}
         \item \methoddesc{\public}{}{void}{setLibrary}{\type{Library} library}
        {Sets the selected element from the outliner as the target library.}{\begin{itemize}
        \item \paramdesc{library}{Selected target library.}
            \end{itemize}}{}
         \item \methoddesc{\public}{}{boolean}{getCopyTag}{}
        {Returns the copy tag}{}{}
         \item \methoddesc{\public}{}{}{setCopyTag}{\type{boolean}}
        {Sets the copy tag}{}{}
    \end{itemize}}{}
...
\classdesc{LoadProjectListener}{\public \class LoadProjectListener implements ActionListener \decl{}{Listener for importing a project}}{
    \begin{itemize}
        \item \atrdesc{\private}{}{Project}{project}{Project which will be loaded to the application.}
    \end{itemize}
}{
    \begin{itemize}
