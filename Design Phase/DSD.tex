...
Stores the data of an attribute
}
{\begin{itemize}
...
Stores the data of an attribut of the \refer{\lblroot:model.elements:InputPin}{input pin}
}
{\begin{itemize}
...
Stores the data of an attribute of the \refer{\lblroot:model.elements:OutputPin}{output pin}
}
{\begin{itemize}
    \item \atrdesc{\proted}{}{\type{float[]}}{index1}{}
...
\classdesc{Leakage}
{
Stores the leakage data of the \refer{\lblroot:model.elements:Cell}{cell}
}
{\begin{itemize}
...
{
Stores the power data of the \refer{\lblroot:model.elements:InputPin}{input pin}
}{
    \begin{itemize}
...
{
Stores the power data of the \refer{\lblroot:model.elements:OutputPin}{output pin}
}{
    \begin{itemize}
        \item \atrdesc{\private}{}{\type{PowerGroup}}{powgroup}{}
    \end{itemize}
...
\classdesc{Timing}
{
Stores the timing data of the \refer{\lblroot:model.elements:Pin}{pin}.
}{
    \begin{itemize}
...
Deletes a \refer{\lblroot:model.elements:Cell}{cell} from a \refer{\lblroot:model.elements:Library}{library}.
}
}{ 

% Make this for multiple cells perhaps? Quite easy to do


    \begin{itemize}
        \item \atrdesc{\private}{}{\type{Cell}}{deletedCell}{The deleted Cell}
    \end{itemize}} 
{   \begin{itemize}
        \item \constrdesc{\public}{DeleteCommand}{\type{Cell} cell}{}
        {
            \begin{itemize}
...
Merges multiple selected \refer{\lblroot:model.elements:Library}{libraries} to a single \refer{\lblroot:model.elements:Library}{library}.
    ...
    \begin{itemize}
        \item \atrdesc{\private}{}{\type{ArrayList<\type{Library}>}}{mergedLibraries}{The merged libraries} %Keep it, don't need for undo, but need for execution
        \item
...
Changes the name of an \refer{\lblroot:model.elements:Element}{element}.
    ...
    \begin{itemize}
        ...
        \item \atrdesc{\private}{}{\type{String}} {oldName}{The old name of the element}
        \item
        \atrdesc{\private}{}{\type{String}}{newName}{The new name of the element}
    \end{itemize}} 
{   \begin{itemize}
...
Creates a \refer{\lblroot:model.elements:Library}{library}.
}}{                                                                                                                                                                                  %What does this even do? I forgot      
    ...
    \end{itemize}} 
{   \begin{itemize}
        \item \constrdesc{\public}{CreateLibraryCommand}{\type{String} name}{}
        {
            \begin{itemize}
...
{   \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \paramdesc{command} {A command that is added to the undo history.}
        \end{itemize}}
        }{}
        ...
        \begin{itemize}
        \item \paramdesc{Command} {Latest command will be returned.}
        \end{itemize}
        }{The latest Command}
    \end{itemize}
    }{}
...
{   \begin{itemize}
        ...
        \end{itemize}
        }{The constructor carries the functionality to resolve all the name conflicts}
    \end{itemize}
}{
    \begin{itemize}
...
The enum that keeps track of the colors corresponding to a \refer{\lblroot:model.project:ColorTheme}{color theme}
    ...
    \begin{itemize}
        ...
        \item \fielddesc{ColorEnum}{SCROLL-BAR_Handle}{The color of the scroll bar handle}
...
\classdesc{EventManager}{\decl{\public \class EventManager}{Holds lists of all listeners and manages their subscription.}}{
    \begin{itemize}
...
\classdesc{SelectListener}{public class LoadLibraryListener implements TreeSelectionListener \decl{}{Observes the selected elements on the outliner.}}{
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        {}{\begin{itemize}
            ...
            \end{itemize}}{}
        \item \methoddesc{\public}{}{\type{ArrayList<Element>}}{getSelectedElements}{}
        {Returns the list of selected elements in the outliner.}{}{}
    \end{itemize}
}{}
\classdesc{OpenElementListener}{public class OpenElementListener implements ActionListener \decl{}{Listener for opening an element in the working area of the application.}
}{
    \begin{itemize}
        \item \atrdesc{\private}{}{Command}{command}{Command for opening a liberty file in working area}
        \item \atrdesc{\private}{}{SelectListener}{listener}{Listener which is observing the selection events on the outliner.}
...
\classdesc{DeleteCellListener}{public class DeleteCellListener implements ActionListener \decl{}{Listener for deleting a cell permanently from a library.}}{
    \begin{itemize}
...
\classdesc{RemoveListener}{public class RemoveListener implements ActionListener \decl{}{Listener for removing an element from the project.}}{
    \begin{itemize}
...
\classdesc{EditListener}{public class EditListener \decl{}{Observes the changes in the text editor.}}{
    ...
    \begin{itemize}
        ...
        {}{\begin{itemize}
            ...
            \end{itemize}}{}
    \end{itemize}}{}
\classdesc{RenameListener}{\public \class RenameListener implements ActionListener \decl{}{Listener for renaming a liberty file in the outliner.}}{
    \begin{itemize}
...
\classdesc{MoveListener}{public class MoveListener implements ActionListener \decl{}{Listener for moving selected cells to another library.}}{
    ...
    \begin{itemize}
        ...
        {}{\begin{itemize}
            ...
            \end{itemize}}{}
    \end{itemize}}{}
\classdesc{CopyListener}{public class CopyListener implements ActionListener \decl{}{Listener for copying selected cells to another library.}}{
    \begin{itemize}
