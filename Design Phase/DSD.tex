...
\usepackage[a4paper,margin=0.4in,left=1in, right=1in]{geometry}
...
\classdesc{SelectListener}{public class SelectListener implements TreeSelectionListener \decl{}{Listens to the selected elements in the outliner.}}{
    \begin{itemize}
...
\classdesc{MoveListener}{public class MoveListener implements ActionListener, TreeSelectionListener \decl{}{Listener for moving selected cells to another library.}}{
    ...
    \begin{itemize}
        ...
        {}\begin{itemize}
            ...
            \end{itemize}{}{}
         \item
        \methoddesc{\public}{}{\type{Element[]}}{getElements}{Returns the elements that will be moved}
        {}{}{}
         \item
        \methoddesc{\public}{}{void}{valueChanged}{\type{TreeSelectionEvent} e}
        {}{\begin{itemize}
...
\classdesc{CopyListener}{public class CopyListener implements ActionListener, TreeSelectionListener \decl{}{Listener for copying selected cells to another library.}}{
    ...
    \begin{itemize}
        ...
        {Returns the elements that will be copied}{}{}
         \item
        \methoddesc{\public}{}{void}{valueChanged}{\type{TreeSelectionEvent} e}
        {}{\begin{itemize}
            \item \paramdesc{e}{Performed selection event on the component.}
...
{The following optional requirements are either covered completely, or fit into existing classes and structures. The remaining optional requirements are not covered in the design phase, but the current design allows for easy extendability.
\begin{itemize}
