...
\interfacedesc{IDiagram}{
    An interface that is implemented by all diagrams.
}{}{
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        {
            Makes a deep copy of the data which the diagram represents (the data attribute) in form of a \type{Collection} instance.
        }{}{
            A deep copy of the data of the diagram.
        }
        ...
        {
            Replaces the data the diagram represents by the given data.
        }{
            \begin{itemize}
                \item \paramdesc{data}{The data to replace the current data of the diagram.}
            \end{itemize}
        }{}
        \item \methoddesc{\public}{}{boolean}{addDiagramViewHelper}{\type{DiagramViewHelper} dvh}
        {
            Adds the given \type{DiagramViewHelper}
        }{
            \begin{itemize}
                \item \paramdesc{dvh}{}
            \end{itemize}
...
\interfacedesc{IDiagramOverlayer}{}{}{
    ...
    \begin{itemize}
        ...
        \item \overridecasclabelname{\lblroot\lblpackage\lblpackageelement:(inds)overlay}{\methoddesc{\public}{}{IDiagram}{overlay}{\type{int[]} indices}
        {}{
            \begin{itemize}
                \item \overridecasclabelname{\lblroot\lblpackage\lblpackageelement:(inds)overlay:indices}{\paramdesc{indices}{}}
            \end{itemize}
        }{}}
        ...
        {}{
            \begin{itemize}
                \item \overridecasclabelname{\lblroot\lblpackage\lblpackageelement:(dgrms)overlay:diagrams}{\paramdesc{diagrams}{}}
            \end{itemize}
        }{}}
    \end{itemize}
}
