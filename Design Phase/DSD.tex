...
\classdesc{Shortcuts}{}{}{
    ...
    \begin{itemize}
        \item \methoddesc{\public}{}{void}{setKey}{\type{KeyStroke} key, \type{Action} action}
        {Binds a key to the action in the model}{
        \begin{itemize}
                \item \paramdesc{key}{The pressed key.}
                \item \paramdesc{action}{The action that corresponds to the key.}
        \end{itemize}
        }{}
        \item \methoddesc{\public}{}{void}{removeKey}{\type{KeyStroke} key}
        {Removes a key from the binding}{
        \begin{itemize}
                \item \paramdesc{key}{The pressed key.}
        \end{itemize}
        }{}
        \item \methoddesc{\public}{}{ArrayList<KeyStroke>}{getKeys}{}
        {Returns all the set keys}{}{}
        \item \methoddesc{\public}{}{Action}{getAction}{\type{KeyStroke} key}
        {Returns the action corresponding to a keystroke}{
        \begin{itemize}
                \item \paramdesc{key}{The pressed key.}
        \end{itemize}
        }{}
...
\enumdesc{Mode}{Keeps track of the mode used to calculate the attribute used on the filter}{
    \begin{itemize}
...
\classdesc{EventManager}{public class EventManager}{
    \begin{itemize}
        ...
        \item \atrdesc{\private}{}{List<ActionListener>}{listeners}{List  }
    \end{itemize}
    }{
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \methoddesc{\public}{}{void}{removeHandlers}{\type{IObserver handler}{}{}{}
