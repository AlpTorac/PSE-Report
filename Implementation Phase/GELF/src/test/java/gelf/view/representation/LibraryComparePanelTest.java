...
ArrayList<Cell> cells = new ArrayList<Cell>();
	...
	void initTest() {
		...
		LibraryComparePanel panel = new LibraryComparePanel(100, 100, s, c, libraries);
		frame.add(panel);
		panel.mouseClicked(new MouseEvent(panel.buttonList.get(0), 0, 0, 0, 0, 0, 1, false));
	}
