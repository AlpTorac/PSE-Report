...
class DataPanelTest {
  ...
  ArrayList<Cell> cells = new ArrayList<Cell>();
	...
	void initTest() {
		...
		DataPanel panel = new DataPanel(100, 100, outPin);
		DataPanel panel2 = new DataPanel(100, 100, inPin);
		DataPanel panel3 = new DataPanel(100, 100, library);
		DataPanel panel4 = new DataPanel(100, 100, cell);
		frame.add(panel);
		frame.add(panel2);
		frame.add(panel3);
		frame.add(panel4);
		panel4.updateSelectedPins(inPins);
	}
