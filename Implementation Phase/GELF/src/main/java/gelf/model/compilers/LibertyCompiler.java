...
/**
 * Compiles the data objects to their Liberty Format equivalents so that they
 * can be saved or displayed in the text editor
 * 
...
public class LibertyCompiler {
    ...
    /**
     * Compiles the data object of an output pin into a string in Liberty File
     * format
     * 
