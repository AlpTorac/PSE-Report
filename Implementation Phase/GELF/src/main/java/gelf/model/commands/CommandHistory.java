...
public class CommandHistory {
     ...
     */
    /*
     * public void setUndoCount(int count) { undoCount = count; while
     * (commands.size() > undoCount) { commands.remove(0); } while
     * (undoneCommands.size() > undoCount) { undoneCommands.remove(0); } }
     */
     ...
     * 
     * @throws InvalidFileFormatException if the parser delivers this error from one
     *                                    of the commands Unlikely to happen, but
     *                                    java needs it covered
     */
