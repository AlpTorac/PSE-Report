...
public interface Command {
     ...
     * 
     * @throws InvalidFileFormatException if a String from the constructor has
     *                                    invalid file format while being executed
     *                                    by the command
     */
    public void execute() throws InvalidFileFormatException;

    /**
     * Undoes the execution of the command, making the necessary changes in the
     * project
     */
    public void undo();
}
