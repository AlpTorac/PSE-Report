...
public class MainWindow extends Window {
    ...
    public MainWindow(String name, int width, int height, Project project) {
        ...
        SubWindow sub1 = new SubWindow(lib1, project, this.subWindowArea, 100, 100);
        sub1.setVisible(true);
        subWindowArea.addSubWindow(sub1);
        SubWindow sub2 = new SubWindow(lib2, project, this.subWindowArea, 100, 100);
        sub2.setBackground(new Color(.2f, .4f, .2f));
        sub2.setVisible(true);
        subWindowArea.addSubWindow(sub2);
        SubWindow sub3 = new SubWindow(lib1, project, this.subWindowArea, 100, 100);
