...
\begin{FR}
    ...
    {A new library will be created containing all the cells from both initial libraries}
...
\begin{itemize}[label=]
    ...
    \item \itemglo{tba}{TBA}{
    Acronym for "To be added."}
    \item \itemglo{working_area}{Working area}{}
    \item \itemglo{project}{Project}{}
    \item \itemglo{timing_sense}{Timing sense}{}
    \item \itemglo{timing_type}{Timing type}{}
    \item \itemglo{timing_group}{Timing group}{}
    ...
    \item \itemglo{heatmap}{Heatmap}{}
    \item \itemglo{scatterplot}{Scatterplot}{}
    \item \itemglo{3d_graph}{3D Graph}{}
    \item \itemglo{function_graph}{Function graph}{}
    \item \itemglo{interpolation}{Interpolation}{}
    \item \itemglo{io}{IO}{}
