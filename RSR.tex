...
\begin{FR}
    ...
    \begin{itemize}
        ...
        \item On the left side of the panel, "Editor" panel from \label{FR-PLACEHOLDER} is open. % FR-PLACEHOLDER is for the functionality the Editor is associated with
