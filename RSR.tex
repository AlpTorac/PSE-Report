...
\begin{FR}
    ...
    \item Visual comparison of attributes \label{FR-34432} % Can merge this one, because how displaying works has already been explained in Displaying a library/cell/pin. Merely describing how comparing works for different types of graphs should work.
...
\begin{FR}
    ...
    {\begin{itemize}
        ...
        \end{itemize}
    \end{itemize}}
    \item \FRDescription{Collapsing/Expanding Element view}
    {Ability to collapse/expand child elements of a parent element in the hierarchical view to hide/show their child elements}
    {Primary}
    {Said parent element is successfully loaded into the project}
    {Child elements of the said parent element are hidden/shown}
    {An appropriate error message is shown}
    {Clicking on the collapse/expand component next to the name of the said parent element}
